...
<button
  ...
  class="fixed top-4 right-4 z-50 p-1 border-none bg-transparent text-black dark:text-white cursor-default hover:bg-black/20 dark:hover:bg-white/20 theme-toggle"
...
<style>
  ...
  .theme-toggle--toggled .theme-toggle__inner-moon path {
    transform: rotate(180deg);
  }

  .theme-toggle--toggled .theme-toggle__inner-moon circle {
